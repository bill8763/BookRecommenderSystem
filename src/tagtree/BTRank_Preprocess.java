...
來源：	2.D:\\DataTemp\\Processing\\TagTree\\" + no + "_File\\MergeOneGramResult.txt
      	...
      	3.D:\\DataTemp\\Processing\\Document\\" + no + "_File\\FilterResult.txt
      	  D:\\DataTemp\\Processing\\TagTree\\" + no + "_File\\NGDResult.txt
      	  D:\\DataTemp\\Processing\\TagTree\\" + no + "_File\\CPResult.txt
目的：D:\\DataTemp\\Processing\\TagTree\\" + no + "_File\\BTRankPreValueResult.txt
...
public class BTRank_Preprocess
{
	...
	{
		Hashtable<String,ArrayList<String>> H_TermNGD = new Hashtable<String,ArrayList<String>>();			// NGD關係<字詞,與其它字詞的NGD值>
		Hashtable<String,ArrayList<String>> H_TermCP = new Hashtable<String,ArrayList<String>>();			// CP關係<字詞,與其它字詞的CP指向>
		Hashtable<String,ArrayList<String>> H_TermOut = new Hashtable<String,ArrayList<String>>();			// NGD關係的CP指向<字詞,與其它字詞關係指向>
		ArrayList<String> A_NGD;
		ArrayList<String> A_CP;
		ArrayList<String> A_Out;
		ArrayList<String> A_Term = new ArrayList<String>();								// 字詞名稱
		
		Hashtable<String,Hashtable<String,Double>> H_TermNGDValue = new Hashtable<String,Hashtable<String,Double>>();	// NGD關係<字詞,<字詞,NGD值>>
		Hashtable<String,Hashtable<String,Double>> H_TermCPValue = new Hashtable<String,Hashtable<String,Double>>();	// CP關係<字詞,<字詞,CP值>>
		Hashtable<String,Double> H_NGD;											// NGD關係<字詞,NGD值>
		Hashtable<String,Double> H_CP;											// CP關係<字詞,CP值>
		...
		// 判斷兩個相關的字詞其正確的指向關係，並將 (CP/NGD) 值輸出
		String  first  = "";
		String  second = "";
