...
public class ConceptInterestLongTerm {
	...
	public static void main(String[] args) throws Exception {
		...
		String startDateString = "2015/05/29";
		Date startDate = dateFormat.parse(startDateString);
		long startTime = (long) startDate.getTime();

		String endDateString = "2015/06/11";
	...
	static void ConceptInterestCalculate_Long(String user,
		...
		if(newArticleFlag){
			...
			/**驗證*/
			List totleArticle =  fileList.getFileList("D:/dataset/mainWords/");
			List correctArticle = fileList.getFileList("D:/dataset/0Bioinformatics_traningAbstract/");
			...
			BufferedWriter bw;
			bw = new BufferedWriter(new FileWriter(toRecommendDocDir+"validation.txt", true));
