...
public class Lucene_Search2 extends HTMLEditorKit.ParserCallback {
	...
	public static void doit(String user_id, int concept_id, int topic_id, String path, HttpIndexSearcher searcher)
			throws Exception {
		...
		FileReader FileStream = new FileReader(path + "Number_of_term/"
				+user_id+"_"+ concept_id + "_" + topic_id + "_number_of_term.txt");
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter(path
				+ "Number_of_pair/" + user_id +"_" +concept_id + "_" + topic_id
