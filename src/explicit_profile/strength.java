...
public class  strength{
	...
	public void concept_strength(int concept_id,int topic_id) throws IOException {	
		...
		br = new BufferedReader(new FileReader("D:/dataset/Concept_K-core/Rank/"+no + "_" + "Rank.txt"));//Ū�X�g�L�ƧǪ�NGD(�L�o�᪺�r����XNGD�����G)
		br2 = new BufferedReader(new FileReader("D:/dataset/Concept_K-core/Stem/"+no + "_" + "stem.txt"));//Ū�X�r��(�g�L�o�᪺�r��)
		br3 = new BufferedReader(new FileReader("D:/dataset/Concept_K-core/Main_word/"+no + "_" + "main_word.txt")); //Ū�Xmain_word
