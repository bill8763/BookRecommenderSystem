...
public class google_filter2 {
	...
	public static void search_filter(int no)  {
		FileReader FileStream;
		try {
			FileStream = new FileReader("D:/K-core/Search2/"+no + "_"
					+ "Lucene_output2.txt");
			...
			FileReader FileStream1 = new FileReader("D:/K-core/Pairs/"+no + "_" + "pairs.txt");
			...
			// Integer sum = 0;
			BufferedWriter bw;
			bw = new BufferedWriter(new FileWriter("D:/K-core/Number_of_pair/"+no + "_"
