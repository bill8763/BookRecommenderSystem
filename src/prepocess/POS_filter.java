...
public class POS_filter {
	...
	public static void filter(int no) throws IOException {
		FileReader FileStream = new FileReader("D:/K-core/Keyword_output_freq/"+no + "_"
		...
		BufferedWriter bw;
		bw = new BufferedWriter(new FileWriter("D:/K-core/POS_filter/"+no + "_" + "filter_output1.txt",
				false));
		String objs_out = "";
