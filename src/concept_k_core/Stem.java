...
public class Stem {
	...
	public static void stemming(int concept_id,int topic_id) throws IOException {
		...
		BufferedWriter bw;
		bw = new BufferedWriter(new FileWriter("D:/DataTemp/Concept_K-core/Stem/"+concept_id + "_" +topic_id + "_stem.txt", false));
